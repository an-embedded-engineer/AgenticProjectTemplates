...
description: プロジェクトの既知課題解決で、課題定義、設計、レビュー、実装、効果確認、文書反映、完了処理までを行う手順。
---
...
- 手順本体: `references/procedure/issue_resolution_workflow.md`
...
4. Phase 2 の設計で効果確認方法と follow-up 切り出し条件を明記する
