...
4. `~/.agentic-project-templates/bin/agentic-agent-cli-tmux.sh` で tmux セッション `agentic-project-templates-orchestrator` を作成し、実装 Agent をペイン 0・レビュー Agent をペイン 1 に起動する
