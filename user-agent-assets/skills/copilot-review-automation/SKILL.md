...
- workflow Phase 構成: `references/procedure/workflow_phase_library/README.md`
...
2. review 文書の出力先を決める
3. prompt file を作成する
   - 一時ファイル例: `${MAIN_PROJECT_DIR}/tmp/agentic_project_templates_copilot_review_prompt.txt`
