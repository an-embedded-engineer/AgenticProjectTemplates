...
- `research-analysis-workflow`
  ...
  - 詳細: `docs/procedure/research_analysis_workflow.md`
...
- tmux 経由 Agent CLI 操作の機械的処理は `tools/AgentCliTmux` に集約する。各 skill / procedure は workflow policy とレビュー依頼内容だけを持つ。
